...
public class Class2 extends AppCompatActivity implements SearchView.OnQueryTextListener {

    private ProgressDialog mProgressDialog;
    private String url = "https://www.oslo.kommune.no/gate-transport-og-parkering/veiarbeid-og-vedlikehold/broyting-og-bortkjoring-av-sno/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sør-øst");
    ...
    private void init() {
        ...
        mDataAdapter = new DataAdapter(Class2.this, mDatoList, mGatenavnList, mStrekningList, mTidspunktList);
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Class2.this);
