...
public class Class3 extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sentrum");
    ...
    private void init() {
        ...
        mDataAdapter = new DataAdapter(Class3.this, mDatoList, mGatenavnList, mStrekningList, mTidspunktList);
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Class3.this);
