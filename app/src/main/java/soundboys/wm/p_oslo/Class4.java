...
public class Class4 extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Vest");
    ...
    private void init() {
        ...
        mDataAdapter = new DataAdapter(Class4.this, mDatoList, mGatenavnList, mStrekningList, mTidspunktList);
    ...
    private class Description extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Class4.this);
